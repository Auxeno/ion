...
| Normalization   | [`BatchNorm`](https://auxeno.github.io/ion/nn/layers/norm/#ion.nn.BatchNorm), [`LayerNorm`](https://auxeno.github.io/ion/nn/layers/norm/#ion.nn.LayerNorm), [`RMSNorm`](https://auxeno.github.io/ion/nn/layers/norm/#ion.nn.RMSNorm), [`GroupNorm`](https://auxeno.github.io/ion/nn/layers/norm/#ion.nn.GroupNorm), [`SpectralNorm`](https://auxeno.github.io/ion/nn/layers/norm/#ion.nn.SpectralNorm) |
| Recurrent       | [`RNNCell`](https://auxeno.github.io/ion/nn/layers/recurrent/#ion.nn.RNNCell), [`LSTMCell`](https://auxeno.github.io/ion/nn/layers/recurrent/#ion.nn.LSTMCell), [`GRUCell`](https://auxeno.github.io/ion/nn/layers/recurrent/#ion.nn.GRUCell), [`RNN`](https://auxeno.github.io/ion/nn/layers/recurrent/#ion.nn.RNN), [`LSTM`](https://auxeno.github.io/ion/nn/layers/recurrent/#ion.nn.LSTM), [`GRU`](https://auxeno.github.io/ion/nn/layers/recurrent/#ion.nn.GRU) |
| SSM             | [`LRUCell`](https://auxeno.github.io/ion/nn/layers/ssm/#ion.nn.LRUCell), [`S4DCell`](https://auxeno.github.io/ion/nn/layers/ssm/#ion.nn.S4DCell), [`S5Cell`](https://auxeno.github.io/ion/nn/layers/ssm/#ion.nn.S5Cell), [`LRU`](https://auxeno.github.io/ion/nn/layers/ssm/#ion.nn.LRU), [`S4D`](https://auxeno.github.io/ion/nn/layers/ssm/#ion.nn.S4D), [`S5`](https://auxeno.github.io/ion/nn/layers/ssm/#ion.nn.S5) |
...
| Embedding       | [`Embedding`](https://auxeno.github.io/ion/nn/layers/embedding/#ion.nn.Embedding), [`LearnedPositionalEmbedding`](https://auxeno.github.io/ion/nn/layers/positional/#ion.nn.LearnedPositionalEmbedding) |
| Positional      | [`RoPE`](https://auxeno.github.io/ion/nn/layers/positional/#ion.nn.RoPE), [`SinusoidalPositionalEmbedding`](https://auxeno.github.io/ion/nn/layers/positional/#ion.nn.SinusoidalPositionalEmbedding) |
| Regularization  | [`Dropout`](https://auxeno.github.io/ion/nn/layers/stochastic/#ion.nn.Dropout) |
| Identity        | [`Identity`](https://auxeno.github.io/ion/nn/layers/identity/#ion.nn.Identity) |
...
| GNN             | [`GCNConv`](https://auxeno.github.io/ion/gnn/layers/gcn/#ion.gnn.GCNConv), [`GraphConv`](https://auxeno.github.io/ion/gnn/layers/gcn/#ion.gnn.GraphConv), [`GATConv`](https://auxeno.github.io/ion/gnn/layers/gat/#ion.gnn.GATConv), [`GATv2Conv`](https://auxeno.github.io/ion/gnn/layers/gat/#ion.gnn.GATv2Conv), [`TransformerConv`](https://auxeno.github.io/ion/gnn/layers/gat/#ion.gnn.TransformerConv), [`GINConv`](https://auxeno.github.io/ion/gnn/layers/gin/#ion.gnn.GINConv), [`SAGEConv`](https://auxeno.github.io/ion/gnn/layers/sage/#ion.gnn.SAGEConv), [`GlobalAttentionPool`](https://auxeno.github.io/ion/gnn/layers/readout/#ion.gnn.GlobalAttentionPool) |
