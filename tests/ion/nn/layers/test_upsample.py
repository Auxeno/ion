...
class TestUpsample1d:
    def test_output_shape(self):
        ...
        layer = nn.Upsample1d(scale_factor=2)
        x = jnp.ones((4, 3))
        y = layer(x)
        assert y.shape == (8, 3)
    ...
    def test_output_shape_batch(self):
        ...
        layer = nn.Upsample1d(scale_factor=3)
        x = jnp.ones((2, 5, 4, 3))
        y = layer(x)
    ...
    def test_nearest(self):
        ...
        layer = nn.Upsample1d(scale_factor=2, mode="nearest")
    ...
    def test_bilinear(self):
        ...
        layer = nn.Upsample1d(scale_factor=2, mode="linear")
        x = jnp.ones((6, 3))
        y = layer(x)
        assert y.shape == (12, 3)
...
class TestUpsample2d:
    def test_output_shape(self):
        ...
        layer = nn.Upsample2d(scale_factor=2)
        x = jnp.ones((4, 4, 3))
        y = layer(x)
    ...
    def test_int_scale_factor(self):
        """Int scale factor is applied to both dimensions."""
        layer = nn.Upsample2d(scale_factor=3)
        x = jnp.ones((2, 2, 1))
        y = layer(x)
        assert y.shape == (6, 6, 1)

    def test_tuple_scale_factor(self):
        """Tuple scale factor applies different factors per dimension."""
        layer = nn.Upsample2d(scale_factor=(2, 3))
        x = jnp.ones((4, 4, 1))
        y = layer(x)
    ...
    def test_nearest(self):
        ...
        layer = nn.Upsample2d(scale_factor=2, mode="nearest")
        x = jnp.array(
            [
                [[1.0], [2.0]],
                [[3.0], [4.0]],
    ...
    def test_bilinear(self):
        ...
        layer = nn.Upsample2d(scale_factor=2, mode="bilinear")
        x = jnp.ones((4, 4, 3))
        y = layer(x)
        assert y.shape == (8, 8, 3)
