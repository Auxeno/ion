...
def _build_layers(key):
    ...
    return [
        ...
        (nn.Conv1d(3, 8, kernel_size=3, padding=1, key=next(keys)), jnp.ones((10, 3))),
        (nn.Conv2d(3, 8, kernel_size=3, padding=1, key=next(keys)), jnp.ones((6, 6, 3))),
        ...
        (nn.MaxPool1d(kernel_size=2), jnp.ones((10, 3))),
        (nn.MaxPool2d(kernel_size=2), jnp.ones((4, 4, 3))),
        (nn.AvgPool1d(kernel_size=2), jnp.ones((10, 3))),
        (nn.AvgPool2d(kernel_size=2), jnp.ones((4, 4, 3))),
        ...
        (nn.ConvTranspose1d(3, 8, kernel_size=3, padding=1, key=next(keys)), jnp.ones((10, 3))),
        (nn.ConvTranspose2d(3, 8, kernel_size=3, padding=1, key=next(keys)), jnp.ones((6, 6, 3))),
